...
def creating_model(act_func,first_size,first_kernel_size,second_size,second_kernel_size):
    model = Sequential()
    ...
    #add dropout layer to regularize and prevent overfitting
...
grid_search.fit(X = train_images_subset, y = train_labels_subset,                validation_data = (valid_images_subset,valid_labels_subset),verbose = 2)
...
# ### 6. Assess the performance to predict the 10 categories of test images and obtain the confusion matrix.
